...
- Contents of the `data/` and `output/` directories and the `FIGURES.pdf` and `SUPPLEMENTARY MATERIAL.pdf` files are licensed under the Creative Commons Attribution 4.0 International license (CC BY 4.0; see `LICENSE-CC-BY-4.0`).

## Abstract

Host age can influence microbiome structure and function, but its impact on microbial responses to dietary contaminants remains unclear. To investigate this, fecal microbiota from female C57BL/6J mice (7-40 weeks) were cultured in vitro with bisphenol S or diisononyl phthalate at 10 or 100 μM and alterations to the microbiome structure and function were assessed by 16S rRNA gene sequencing and untargeted LC-MS metabolomics, respectively. We hypothesized that communities derived from younger mice would demonstrate pronounced disruption in composition and/or function. Surprisingly, the metabolomic profiles from mature (22-week) and aging (40-week) donors exhibited the most pronounced, age-dependent alterations following 100 μM BPS or DINP exposure. Moreover, despite robust metabolic shifts, no significant differences in community composition or individual taxa were detected, indicating functional plasticity without dysbiosis. Analysis of metabolomic and predicted functional profiles revealed age- and exposure-responsive metabolic pathways, particularly short-chain fatty acid and amino acid metabolism for DINP, and indole alkaloid and lipid-related metabolism for BPS, some of which overlap with known bisphenol and phthalate effects. Our results suggest that host age affects microbiome metabolic susceptibility to dietary plastics and identifies a small set of metabolic endpoints that may serve as sensitive markers of microbiome vulnerability in future studies using human-relevant exposure levels.
